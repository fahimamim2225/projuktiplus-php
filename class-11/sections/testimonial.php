<section class="bg-[#2E2100] py-[96px]">
    <div class="container">
        <div class="test-slider">
            <div class="test-slider-wrapper">
                <div class="single-test-slider">
                    <div class="flex justify-between items-start">
                        <div class="w-4/12">
                            <div class="space-y-2">
                                <img src="assets/images/avatar1.png" alt="">
                                <h5 class="text-[#F7F7F7] sen text-[24px] font-bold leading-[34px]">Peter Moor</h5>
                                <p class="text-[#BFBCB2] poppins text-[14px] font-normal leading-[26px]">Student of Web Design</p>
                            </div>
                        </div>
                        <div class="w-8/12">
                            <div class="">
                                ...
                                <p class="text-white poppins text-[26px] italic font-normal leading-[40px] pl-4">Not only does my resume look impressive—filled with the names and logos of world-class institutions—but these certificates also bring me closer to my career goals by validating the skills I've learned."</p>
                            </div>
                        </div>
                    </div>
                </div>
